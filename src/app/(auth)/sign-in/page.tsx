      ...
      <div className="relative hidden w-1/2 flex-col justify-between overflow-hidden bg-[oklch(0.18_0.03_250)] p-12 lg:flex">
        ...
        <div className="absolute left-0 top-0 h-full w-[6px]">
          <div className="h-full w-full" style={{
            background: 'repeating-linear-gradient(180deg, #D4A843 0px, #D4A843 20px, #006B3F 20px, #006B3F 40px, #0C1B2A 40px, #0C1B2A 60px)'
          }} />
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <blockquote className="border-l-2 border-[#D4A843] pl-6">
            <p className="font-heading text-2xl font-semibold leading-relaxed text-white/90">
          ...
          <div className="flex gap-8 text-white/40">
            <div>
              ...
              <p className="mt-1 text-xs uppercase tracking-wider">Revenue Tracking</p>
            </div>
            <div className="h-12 w-px bg-white/10" />
            <div>
              <p className="font-heading text-3xl font-bold text-[#006B3F]">2</p>
              <p className="mt-1 text-xs uppercase tracking-wider">Platforms Monitored</p>
            </div>
            <div className="h-12 w-px bg-white/10" />
            <div>
              <p className="font-heading text-3xl font-bold text-white/70">16</p>
              <p className="mt-1 text-xs uppercase tracking-wider">Regions Covered</p>
            </div>
          </div>
        </div>
            ...
            {mode === 'signUp' && (
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-lg border border-input bg-card px-4 py-2.5 text-sm text-foreground transition-colors placeholder:text-muted-foreground/50 focus:border-accent focus:outline-none focus:ring-2 focus:ring-accent/20"
                />
              </div>
            )}
